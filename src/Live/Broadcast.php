...
namespace Deepayan\LaraSpeak\Live;
...
class Broadcast
{
    ...
    /*
     * Constant for laraspeak config prefix
     *
     * @const string
     * */
    const CONFIG_PATH = 'laraspeak';

    /*
   * Set all configs from laraspeak configurations
   *
   * @var array
   * */
    protected $config;
   ...
   * */
    ...
    /**
     * get specific config from laraspeak configurations.
     *
     * @param  string
     *
