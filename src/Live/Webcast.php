...
class Webcast implements ShouldQueue
{
   ...
   * */
     ...
     *
     * @param \Deepayan\LaraSpeak\Live\Broadcast $broadcast
     * @return void
     */
    public function handle(Broadcast $broadcast)
    {
        ...
        $this->broadcast->pusher->trigger([sha1($channelForUser), sha1($channelForConversation)], 'laraspeak-send-message', $this->message);
    }
}
