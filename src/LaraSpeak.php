...
use Deepayan\LaraSpeak\Messages\Message;
use Deepayan\LaraSpeak\Messages\MessageRepository;
use Deepayan\LaraSpeak\Live\Broadcast;
...
class LaraSpeak
{
     ...
     *
     *@param \LaraSpeak\Conversations\Conversation $conversations
     *@return object|bool
     */
     ...
     *
     * @param   int $id
     * @return  \Deepayan\LaraSpeak\LaraSpeak|bool
     * */
    ...
    public function getReceiverInfo($conversationId)
    {
        ...
        $userModel = $this->config->get('laraspeak.user.model');
        $user = new $userModel();
